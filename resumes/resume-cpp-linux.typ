...
#custom-title("Projects")[
  ...
  #project-heading(
    ...
    - _*Key Skills:* C/C++, Linux Kernel, eBPF, TCP/IP, Systems Programming_
    - Developed eBPF programs to observe and dynamically modify TCP congestion window behavior via kernel hooks and user-space controlled BPF maps. Implemented safe kernel-user space interaction using libbpf and bpftool to enable runtime control, tracing, and performance analysis.
  ]
]
